...
execute unless data entity @s Items[{Slot:0b}] run loot give @p loot cheats:get_items/dungeons/implosion
execute unless data entity @s Items[{Slot:1b}] run loot give @p loot cheats:get_items/dungeons/shadow_warp
execute unless data entity @s Items[{Slot:2b}] run loot give @p loot cheats:get_items/dungeons/wither_shield
...
execute if entity @s[scores={M_PageDelay=0},nbt=!{Items:[{Slot: 21b, id: "minecraft:arrow", Count: 1b}]}] run scoreboard players set @s M_NewPage 99
...
loot replace entity @s container.0 loot cheats:menu/get_items/other/materials/1
#------------------------------------------#